...
public class RoleParseException extends GameParseException
{
	...
	public RoleParseException(String message, Throwable cause){ super(message, cause); }
	public RoleParseException(Throwable cause){ super(cause); }
	
	protected RoleParseException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace)
	{
